import type { Preset, PresetItem } from '@/types/mixer';

export function hasSameTrackMultiset(leftTrackIds: string[] = [], rightTrackIds: string[] = []): boolean {
...
export function buildPresetItems(presets: Preset[] = [], selectedTrackIds: string[] = []): PresetItem[] {
